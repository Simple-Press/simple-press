...
The plugin has undergone rigorous testing and offers complete support for PHP 7.4 up to PHP 8.4.
...
= 6.11.12 - January 2026 =
* Fixed issue with spam and math question for guest posts

= 6.11.11 - December 2025 =
* Added allowed attributes to fix compatibility issues with Poll addon
* Fixed query errors caused by improper table name quoting. Thanks! https://github.com/terresquall
* Fixed null reference exceptions that were triggering warnings https://github.com/terresquall
* Fixed nonce validation for delete operations
* Fixed issues preventing topic deletion
...
* Cleaned up codebase by removing deprecated oEmbed imports

= 6.11.8 - August 2025 =
* Fixed translation handling to ensure translations load correctly
* Improved search to resolve errors with the Search by User add-on
* Fixed pagination issues in search results
* Continued updates to use global allowed HTML tags for safer output

= 6.11.7 - August 2025 =
* Fixed missing Edit button in forum posts
* Security fix addressing a vulnerability reported via Patchstack
...
* Resolved RSS CDATA double-escaping issue
* Enhanced pagination handling for smoother navigation
* Fixed user group listing to ensure consistent output
* Continued update to use global allowed HTML tags

= 6.11.3 - July 2025 =
* Fixed license verification and activation issues affecting some Pro users
* Corrected HTML escaping in licensing admin and plugin update outputs

= 6.11.2 - July 2025 =
* Fixed post deletion issues on mobile devices
* Improved license verification handling
* Fixed saving issues in some plugins
* Minor HTML escaping corrections throughout the codebase

= 6.11.1 - July 2025 =
* Fixed mobile output rendering issues
* Multiple output fixes applied for improved desktop view rendering.
* Improved content filtering by centralizing allowed HTML tags into a global constant 
* Added support for custom attributes within allowed tags
...
= 6.10.12 - January 2025 =
* Improved security by sanitizing inputs in plugin search functionality to prevent potential vulnerabilities.

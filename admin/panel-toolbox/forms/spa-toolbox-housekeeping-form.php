...
?>
			<div class="collapsible-closed">
<?php
				echo '<p class="sf-sublabel">'.SP()->primitives->admin_text('This will go through the users and posts database tables and recalculate post counts for all users based on existing posts.').'</p>';
?>
...
?>
				...
				<?php echo sp_create_nonce('forum-adminform_housekeeping'); ?><br />
				<input type="submit" class="sf-button-primary spShowElement" id="saveit4" name="transient-cleanup" value="<?php SP()->primitives->admin_etext('Clean Up Transients'); ?>" data-target="#tcimg" />
...
?>
				...
				<?php echo sp_create_nonce('forum-adminform_housekeeping'); ?>
				<input type="submit" class="sf-button-primary spShowElement" id="saveit5" name="reset-tabs" value="<?php SP()->primitives->admin_etext('Reset Profile Tabs'); ?>" data-target="#rdptimg" />
...
?>
				...
				<?php echo sp_create_nonce('forum-adminform_housekeeping'); ?>
				<input type="submit" class="sf-button-primary spShowElement" id="saveit6" name="reset-auths" value="<?php SP()->primitives->admin_etext('Reset Auths Cache'); ?>" data-target="#rtacimg" />
...
?>
				...
				<?php echo sp_create_nonce('forum-adminform_housekeeping'); ?>
				<input type="submit" class="sf-button-primary spShowElement" id="saveit10" name="reset-plugin-data" value="<?php SP()->primitives->admin_etext('Reset Users Plugin Data'); ?>" data-target="#rrpdimg" />
...
?>
				...
				<?php echo sp_create_nonce('forum-adminform_housekeeping'); ?>
				<input type="submit" class="sf-button-primary spShowElement" id="saveit7" name="reset-combinedcss" value="<?php SP()->primitives->admin_etext('Reset Combined CSS Cache'); ?>" data-target="#rtccimg" />
				<input type="submit" class="sf-button-primary spShowElement" id="saveit8" name="reset-combinedjs" value="<?php SP()->primitives->admin_etext('Reset Combined Script Cache'); ?>" data-target="#rtccimg" />
...
?>
				...
				<?php echo sp_create_nonce('forum-adminform_housekeeping'); ?>
				<input type="submit" class="sf-button-primary spShowElement" id="saveit9" name="flushcache" value="<?php SP()->primitives->admin_etext('Flush General Cache'); ?>" data-target="#fcacheimg" />
...
?>
				...
				<?php echo sp_create_nonce('forum-adminform_housekeeping'); ?>
				<input type="submit" class="sf-button-primary spShowElement" id="saveit10" name="flushxmlcache" value="<?php SP()->primitives->admin_etext('Flush XML API Cache'); ?>" data-target="#fcachexml" />

...
#== FORUM RANKS Tab ============================================================
	...
	spa_paint_open_tab(SP()->primitives->admin_text('Components').' - '.SP()->primitives->admin_text('Standard Forum Ranks'), true);
...
?>
	...
	<input type="submit" class="button-primary" id="saveit" name="saveit" value="<?php SP()->primitives->admin_etext('Update Forum Ranks Components'); ?>" />
	</div>
<?php
	spa_paint_close_tab();
?>
...
?>
	<table class="widefat fixed striped spMobileTable1280">
		<thead>
			<tr>
				<th style='text-align:center'><?php SP()->primitives->admin_etext('Forum Rank Name'); ?></th>
				<th style='text-align:center'><?php SP()->primitives->admin_etext('# Posts For Rank'); ?></th>
				<th style='text-align:center'><?php SP()->primitives->admin_etext('Automatic User Group Membership'); ?></th>
...
?>
		...
		<td data-label='<?php SP()->primitives->admin_etext('Forum Rank Name'); ?>'>
		...
		<td data-label='<?php SP()->primitives->admin_etext('# Posts For Rank'); ?>'>
		...
		<td data-label='<?php SP()->primitives->admin_etext('Auto User Group'); ?>'>
...
?>
		...
		<td data-label='<?php SP()->primitives->admin_etext('Badge'); ?>'>
			...
			spa_select_iconset_icon_picker( 'rankbadge[]', __( 'Select Badge' ), array('Badges' => $badges ), $ranks['badge'][$x] );

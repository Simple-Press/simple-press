<div class="codex">
	...
	<img class="spLeft" src="<?php echo esc_html(SPCOMMONIMAGES); ?>theme.png" alt="" title="" />
	<div class="codex-head">Simple:Press Themes</div>
	<div class="clearboth"></div>

	<p>Please visit our <a href="<?php echo esc_html(SPHOMESITE); ?>/store/all-premium-themes//">Theme Library</a></p>

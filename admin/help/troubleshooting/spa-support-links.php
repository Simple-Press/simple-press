<div class="codex">
	...
	<img class="spLeft" src="<?php echo esc_html(SPCOMMONIMAGES); ?>member.png" alt="" title="" />
	...
	<p>For pricing and other information please visit <a href="<?php echo esc_html(SPHOMESITE); ?>/store/add-ons/" >

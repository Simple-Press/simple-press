...
?>
                                            <span class='floatListLabel'><?php echo SP()->primitives->admin_text('Manage Admins'); ?></span>
											<input type="hidden" name="manage-admins[<?php echo $adminId ?>]" value="<?php echo $manage_admins; ?>" />
											<img src="<?php echo SPADMINIMAGES.'sp_Locked.png'; ?>" alt="" style="vertical-align:middle;padding:0 0 0 10px;margin:3px 0;" />
<?php
										} else {
...
?>
	<table style="text-align:center;padding:0;border-spacing:0;border-collapse:separate;" class="forum-table">
		<tr>
			<th style="text-align:center"><?php SP()->primitives->admin_etext('Select New Admin Users'); ?></th>
		</tr>
		<tr>
			<td style="text-align:center">
				<p style="text-align:center"><?php SP()->primitives->admin_etext('Select members to make Admins (use CONTROL for multiple users)'); ?></p>
<?php
...
?>
	<table style="text-align:center;width:auto;padding:0;border-spacing:0;border-collapse:separate;" class="sfmaintable">
		<tr>
			...
			<th style="text-align:center"><?php SP()->primitives->admin_etext('User ID'); ?></th>
			<th style="text-align:center" scope="col"><?php SP()->primitives->admin_etext('Admin Name'); ?></th>
			<th style="text-align:center;width:30px" scope="col"></th>
		</tr>
<?php
        $args = array(

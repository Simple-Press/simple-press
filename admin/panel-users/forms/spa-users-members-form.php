...
function spa_users_members_form() {
    ...
    <form id="members-filter" method="get" action="<?php echo SPADMINUSER; ?>">
        ...
        <div class="sf-panel-body-top">
            ...
            <div class="sf-panel-body-top-right sf-showm">
                <p class="search-box">
                    <input type="search sf-width-100-per" id="<?php echo esc_attr( 'search_id' ); ?>" name="s" value="<?php _admin_search_query(); ?>" form="plugin-filter"
                           placeholder="<?php echo SP()->primitives->admin_text( 'Search members' ) ?>"/>
                </p>
                <div class="sf-pd-15">
    ...
    <script>
        ...
        jQuery('<div class="sf-showm sf-dropdown"></div>').insertBefore('#members-filter .sf-panel-body-top .subsubsub');
        jQuery('#members-filter .sf-panel-body-top .subsubsub').appendTo('#members-filter .sf-panel-body-top .sf-dropdown');

        jQuery('<div class="sf-showm sf-dropdown-cur">'+ jQuery('#members-filter .subsubsub .current').text()  +'</div>').insertBefore('#members-filter .sf-panel-body-top .sf-dropdown .subsubsub');

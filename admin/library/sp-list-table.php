...
class SP_List_Table {
    ...
    public function ajax_user_can() {
        die('function SP_List_Table::ajax_user_can() must be over-ridden in a sub-class.');
    }

    /**
     * Prepares the list of items for displaying.
     * @uses SP_List_Table::set_pagination_args()
     *
     * @since 3.1.0
     * @abstract
     */
    public function prepare_items() {
        die('function SP_List_Table::prepare_items() must be over-ridden in a sub-class.');
    }
    ...
    public function get_columns() {
        die('function SP_List_Table::get_columns() must be over-ridden in a sub-class.');
    }
    ...
    /**
     * Public wrapper for SP_List_Table::get_default_primary_column_name().
     *
     * @since 4.4.0
     *
    ...
    protected function get_primary_column_name() {
        ...
        if (!isset($columns[$default])) {
            $default = SP_List_Table::get_default_primary_column_name();
        }
    ...
    /**
     * Get a list of CSS classes for the SP_List_Table table tag.
     *
     * @since 3.1.0
     *

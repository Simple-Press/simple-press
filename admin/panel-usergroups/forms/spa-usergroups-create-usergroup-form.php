		...
		spa_paint_open_tab(SP()->primitives->admin_text('User Groups').' - '.SP()->primitives->admin_text('Create New User Group'), true);
			spa_paint_open_panel();
				spa_paint_open_fieldset(SP()->primitives->admin_text('Create New User Group'), 'true', 'edit-user-group');
					...
					spa_paint_checkbox(SP()->primitives->admin_text('Allow members to join usergroup'), 'usergroup_join', false, false, false, false, '<small>'.SP()->primitives->admin_text('(Indicates that members are allowed to choose to join this usergroup on their profile page)').'</small>');
					spa_paint_checkbox(SP()->primitives->admin_text('Hide members from user statistics'), 'hide_stats', false, false, false, false, '<small>'.SP()->primitives->admin_text('(This applies to the basic statistics optionally displayed on forum pages)').'</small>');
					spa_paint_checkbox(SP()->primitives->admin_text('Is moderator'), 'usergroup_is_moderator', false, false, false, false, '<small>'.SP()->primitives->admin_text('(Indicates that members of this usergroup are considered Moderators)').'</small>');
...
?>
		...
		<input type="submit" class="button-primary" id="saveit" name="saveit" value="<?php SP()->primitives->admin_etext('Create New User Group'); ?>" />
		</div>

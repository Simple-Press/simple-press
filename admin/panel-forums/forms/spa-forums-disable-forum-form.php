...
?>
		<div class="sfform-submit-bar">
    		...
    		<input type="button" class="button-primary spCancelForm" data-target="#forum-<?php echo $forum_id; ?>" id="sfforumdisable<?php echo $forum_id; ?>" name="disableforumcancel<?php echo $forum_id; ?>" value="<?php spa_etext('Cancel'); ?>" />
		</div>

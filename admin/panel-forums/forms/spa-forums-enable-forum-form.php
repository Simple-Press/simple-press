...
?>
		<div class="sfform-submit-bar">
    		<input type="submit" class="button-primary" id="sfforumenable<?php echo $forum_id; ?>" name="sfforumenable<?php echo $forum_id; ?>" value="<?php SP()->primitives->admin_etext('Enable Forum'); ?>" />
    		<input type="button" class="button-primary spCancelForm" data-target="#forum-<?php echo $forum_id; ?>" id="sfforumenable<?php echo $forum_id; ?>" name="enableforumcancel<?php echo $forum_id; ?>" value="<?php SP()->primitives->admin_etext('Cancel'); ?>" />
    	</div>

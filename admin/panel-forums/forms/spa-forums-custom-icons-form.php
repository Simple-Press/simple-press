			...
			new AjaxUpload(button,{
				...
				onComplete: function(file, response){
					...
					if (response==="success"){
						...
						$('#sf-custom-icons').append('<tr id="'+row_id+'"><td class="spWFBorder"><img class="sfcustomicon" src="<?php echo SPCUSTOMURL; ?>/' + file + '" alt="" /></td><td class="spWFBorder sflabel">' + file + '</td><td class="spWFBorder"><span title="<?php echo esc_js(SP()->primitives->admin_text('Delete custom icon')); ?>" class="sf-icon sf-delete spDeleteRow" data-url="' + site + '" data-target="' + row_id + '"></span></td></tr>');

...
# Start of Upgrade Routines - 6.10.11 =========================================================
$section = 15901;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.10.12 =========================================================
$section = 15902;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.10.13 =========================================================
$section = 15903;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.11.0 ==========================================================
$section = 15904;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.11.1 ==========================================================
$section = 15905;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.11.2 ==========================================================
$section = 15906;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.11.3 ==========================================================
$section = 15907;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.11.4 ==========================================================
$section = 15908;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.11.5 ==========================================================
$section = 15909;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.11.6 ==========================================================
$section = 15910;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.11.7 ==========================================================
$section = 15911;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.11.8 ==========================================================
$section = 15912;
if ($build < $section) {
    sp_response($section);
}
...
# Start of Upgrade Routines - 6.11.12 ==========================================================
$section = 15916;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.11.13 ==========================================================
$section = 15917;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.11.14 ==========================================================
$section = 15918;
if ($build < $section) {
    sp_response($section);
}

# Start of Upgrade Routines - 6.11.15 ==========================================================
$section = 15919;
if ($build < $section) {
    sp_response($section);
}
